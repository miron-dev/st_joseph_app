...
// ========================================== Modal Edit Task ==========================================
    ...
    $('.modal-footer').on('click', '.edit', function() {
        var test = $('#buildings_id_edit').val($(this).data('buildings')).trigger('change');
        ...
        $.ajax({
            ...
            data: {
                ...
                'buildingsNames': $('#buildings_id_edit').val(),
                'classrooms_id': $('#classrooms_id').val(),
            },
            success: function(data) {
...
// ========================================== End Modal Show Approve ==========================================
    $(document).on('click', '.show-modal', function() {
        ...
        $.each($(this).data('buildings'), function( index, value ) {
            console.log(value.name);
            buildingsName.push(value.name);
        });

        $.each($(this).data('classrooms'), function( index, value ) {
            console.log(value.name);
            classroomsName.push(value.name);
        });

        $.each($(this).data('users_task'), function( index, value ) {
            console.log(value.name);
            userTasksName.push(value.name);
        });
        ...
        $('#buildingsName_show').val(buildingsName.toString());
        $('#classroomsName_show').val(classroomsName.toString());
        $('#usersName_show').val(userTasksName.toString());
